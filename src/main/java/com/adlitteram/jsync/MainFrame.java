...
public class MainFrame extends JFrame implements Logger {
   ...
   protected JMenu buildFileMenu() {
      ...
      art.addActionListener((ActionEvent e) -> {
      ...
      prf.addActionListener((ActionEvent e) -> {
         PrefDialog.createAndShow(MainFrame.this);
      });
   ...
   protected JMenu buildChanMenu() {
      ...
      nou.addActionListener((ActionEvent e) -> {
      ...
      arr.addActionListener((ActionEvent e) -> {
         int index = channelTable.getSelectedRow();
         if (index >= 0 && index < channelList.size()) {
      ...
      dem.addActionListener((ActionEvent e) -> {
         int index = channelTable.getSelectedRow();
         if (index >= 0 && index < channelList.size()) {
   ...
   protected JMenu buildHelpMenu() {
      ...
      about.addActionListener((ActionEvent e) -> {
         AboutDialog.createAndShow(MainFrame.this);
      });
   ...
   public class ChannelTableModel extends AbstractTableModel {
      ...
      public Object getValueAt(int row, int col) {
         Channel ch = (Channel) channelList.get(row);
         switch (col) {
            case 0:
               return ch.getIdent();
            case 1:
